...
export function ShareLoadoutButton({ loadout, weapons, initialShareSlug, variant = "button" }: ShareLoadoutButtonProps) {
  ...
  return (
    <div className="relative">
      <button onClick={() => setIsOpen((v) => !v)} className={triggerClass}>
        Share
      </button>
      ...
      {isOpen ? (
        <>
          ...
          <div className="absolute right-0 z-20 mt-2 w-80 border border-accent bg-surface p-4 shadow-xl text-left">
