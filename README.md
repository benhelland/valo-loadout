...
**Status:** live at [valoadout.com](https://valoadout.com). Feature-complete through Phase 3, with store notifications not yet wired to a Discord bot. See [`docs/ROADMAP.md`](./docs/ROADMAP.md) for what's done and what's left.
